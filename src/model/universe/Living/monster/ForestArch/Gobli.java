...
public class Gobli extends Living  implements Berserker {
    ...
    public Gobli() {
        ...
        livingAnimations.addAnimation("Idle",new ImageAnimated("src/res/living/Gobli/Idle", 150, true, BookContent.getRatioD()));
        livingAnimations.addAnimation("Attack 1",new ImageAnimated("src/res/living/Gobli/Attack", 150, true, BookContent.getRatioD()));
        livingAnimations.addAnimation("Death",new ImageAnimated("src/res/living/Gobli/Death", 150, true, BookContent.getRatioD()));
        livingAnimations.addAnimation("TakeHit",new ImageAnimated("src/res/living/Gobli/TakeHit", 150, true, BookContent.getRatioD()));
        livingAnimations.addAnimation("Walk", new ImageAnimated("src/res/living/Gobli/Walk", 150, true, BookContent.getRatioD()));
    }
